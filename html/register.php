...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["email"])) || !filter_var(trim($_POST["email"]), FILTER_VALIDATE_EMAIL)){
        $email_err = "Введите действующий email.";
    } else{
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){
                    $email_err = "Данный адрес уже зарегистрирован.";
                } else{
    ...
    if(empty(trim($_POST["username"]))){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){
                    $username_err = "Данный логин уже занят.";
                } else{
    ...
    if(empty(trim($_POST["password"]))){
        ...
        $password_err = "В пароле должно быть минимум 6 символов.";
    } else{
...
<body>
    ...
    <div class="forms">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p class="text">Уже зарегистрированы? <a href="login.php">Войдите</a>.</p>
        </form>
    </div>    
</body>
</html>
